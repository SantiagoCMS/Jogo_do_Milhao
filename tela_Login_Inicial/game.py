import pygame
from tela_Login_Inicial.menus import MainMenu, OptionsMenu
from tela_Login_Inicial.assets import Assets
from tela_Login_Inicial.subjects_menu import SubjectsMenu
